...
const diagnosticPreviewCases = [
  {
    config: 'configs/js.js',
    expectedRuleIds: ['prettier/prettier', '@unix/function-blank-lines'],
    filePath: 'fixtures/js/single-line-pair-whitespace.js',
    name: 'js single-line pair whitespace diagnostics',
    source: [
  ...
  {
    config: 'configs/js.js',
    expectedRuleIds: ['@unix/function-blank-lines'],
    filePath: 'fixtures/js/compact-return-if-blank-line.js',
    name: 'js compact return-if single-line pair diagnostics',
    source: [
      'const readAccess = context => {',
      '  const required = String(context)',
      '',
  ...
  },
  {
    config: 'configs/js.js',
    expectedRuleIds: [],
    filePath: 'fixtures/js/block-adjacent-blank-line.js',
    name: 'js block-adjacent blank line diagnostics',
    source: [
      'const readAccess = context => {',
      '  const labels = []',
      '',
